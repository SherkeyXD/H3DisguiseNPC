...
public class GlobalOutfitKit
{
    ...
    public bool HeroDisguiseAvailable =>
        Program.mem.readLong((Address + 168).ToString("X2")) == -4647714815446351616L;
    ...
    public static async Task<long> GetPointerAddress()
    {
        ...
        return (
                await Program.mem.AoBScan(
                    536870912L,
                    805306368L,
                    "00 01 00 00 00 00 80 BF 00 00 00 00 00 00 00 00",
                    writable: true,
                    executable: false
                )
            ).FirstOrDefault() - 168;
